  ...
  return (
    <>
      ...
      <PageHero
        ...
        lead="Education and agent counts here reflect sample data for local development; reforestation totals read live from CeloHTReforestation once connected."
      />
      ...
      <Section eyebrow="Reforestation" title="">
        ...
        />
        <p className="mt-4 text-sm text-parchment-100/60">Verified donation totals appear here from CeloHTReforestation. The current project catalog is informational and does not represent a fixed tree conversion.</p>
