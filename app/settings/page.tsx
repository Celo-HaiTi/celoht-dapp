...
export default function SettingsPage() {
  ...
  return <div className="settings-shell min-h-[calc(100dvh-64px)] px-4 py-6 pb-28 sm:px-6 lg:px-8 lg:py-8"><div className="mx-auto max-w-6xl"><header className="settings-header"><div><p className="section-kicker">{t("settings.eyebrow")}</p><h1 className="mt-2 font-display text-3xl font-semibold tracking-tight text-white sm:text-4xl">{t("settings.title")}</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-parchment-100/58">{t("settings.description")}</p></div><Link href="/profile" className="settings-header-link"><ShieldCheck size={16} aria-hidden="true" /> {t("settings.openProfile")}</Link></header>
